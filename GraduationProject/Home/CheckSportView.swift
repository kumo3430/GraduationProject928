                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    HStack {
                        VStack(alignment: .leading) {
                            ...
                            Text("\(todo.sportValue, specifier: "%.1f") \(todo.sportUnits)")
                        ...
                        VStack(alignment: .trailing) {
                            ...
                            Text("\(accumulatedValue, specifier: "%.1f") \(todo.sportUnits)")
                                .font(.system(size: 18, weight: .semibold, design: .default))
                                .foregroundColor(customBlue)
                        }
                    }
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            if accumulatedValue >= todo.sportValue {
                                isCompleted = true
                                withAnimation {
